                ...
                <div className="lg:w-2/4 w-5/6 bg-stone-100">
                    ...
                    grid grid-cols-1 py-2 px-2">
                        ...
                        <div className="text-neutral-600 px-3 py-2 mb-4 flex flex-col">
                            ...
                            <input id="i_name" name="i_name" type="text" className="bg-transparent font-sans caret-slate-400 pt-2 pb-1 w-full px-4 border border-neutral-300 focus:border-sky-600 
                        ...
                        <div className="text-neutral-600 px-3 py-2 mb-4 flex flex-col">
                            ...
                            <input id="degree" name="degree" type="text" className="bg-transparent font-sans caret-slate-400 pt-2 pb-1 w-full px-4 border border-neutral-300 focus:border-sky-600 
                             text-gray-600 focus:bg-neutral-100 antialiased text-base focus:outline-none rounded-md" placeholder="" />
                        </div>
                        <div className="text-neutral-600 px-3 py-2 mb-4 flex flex-col">
                            <label className="font-sans mb-2 text-lg font-medium">{props.title3}</label>
                            <input id="grade" name="grade" type="text" className="bg-transparent font-sans caret-slate-400 pt-2 pb-1 w-full px-4 border border-neutral-300 focus:border-sky-600 
